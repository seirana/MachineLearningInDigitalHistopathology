...
for file in sorted(os.listdir(img_addrs)):
    if file.endswith(".ndpi"):         
        Preprocessing(img_addrs, result_addrs, information, pixel_info, file)
...
class Preprocessing(img_addrs, result_addrs, information, pixel_info, file):     
    ...
    def Build_jpeg_image(levelCount, levelDimension, slide, result_addrs, file_name):
        ...
        return org_gray_scale, gray_scale, img_th    
    
    '''
    define a new function
    '''
    ##find and apply isodata threshold on the image 
    def isodata(org_gray_scale, gray_scale, img_th, result_addrs, file_name):    
